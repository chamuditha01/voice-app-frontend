...
      findSpeaker();
      ...
      const fetchReviews = async () => {
        const { data: reviewsData, error: reviewsError } = await supabase
          .from('reviews')
          .select('rating, feedback, reviewed_id')
...
        <h2 style={styles.cardHeading}>Start a Conversation</h2>
        <p style={styles.cardText}>Tap the button below to connect with a native speaker.</p>
       <CallComponent/>
      </div>
